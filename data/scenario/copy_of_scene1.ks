...
[playbgm  volume="50"  time="0"  loop="true"  storage="audiostock_1023403_opening.mp3"  ]
...
[stopse  time="1000"  buf="0"  ]
[bg  time="1000"  method="crossfade"  storage="train_morning_quitter2.png"  ]
...
[mask_off  time="500"  effect="fadeOut"  ]
[playbgm  volume="60"  time="1000"  loop="true"  storage="audiostock_1557823_fuemi1_(mp3cut.net)-3.mp3"  ]
[chara_show  name="ふえみ"  time="0"  wait="true"  storage="chara/1/aino_basic_middle_silhouette_re.png"  width="1280"  height="720"  ]
[playse  volume="70"  time="1000"  buf="0"  storage="fuemi_neetyotto.mp3"  ]
[tb_start_text mode=1 ]
#？？？
「ねえ……ちょっと……！」[p]
[_tb_end_text]
...
[playse  volume="70"  time="1000"  buf="0"  storage="fuemin_kokogadokokawakattennno_volumeup.mp3"  ]
[iscript]
...
[tb_start_text mode=1 ]
#ふえみ
「そうよ！あんたが今ここに立っていること自体、この空間にいる女性たちへの『[font color=#fc009c][tip key="microaggression"]マイクロアグレッション[endtip][font color=#000000]』だって自覚はあるのかしら？」[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#&f.player
「そこまで言うなら、その『パターナリズム』とやらの定義を教えてくれ。何が良くて、何がダメなのか」[p]
[_tb_end_text]

*common1

[stopbgm  time="1000"  ]
[playbgm  volume="20"  time="1000"  loop="true"  storage="audiostock_988217_fuemi_awawa.mp3"  ]
...
[tb_start_text mode=1 ]
#ふえみ
「えっ……？定義？それは……その、『[font color=#fc009c][tip key="intersectionality"]インターセクショナリティ[endtip][font color=#000000]』の観点から、被差別側の主観を尊重して……」[p]
#&f.player
