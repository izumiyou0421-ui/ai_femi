;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=470 left=20 ]
			...
			[position page=fore frame="comment3.png" margint=85 marginl=20 marginr=20 marginb=15 vertical=false opacity="255" ]
		...
		;キャラクターフォーカスなど
		[chara_config  talk_focus="none" talk_anim="down" ]
